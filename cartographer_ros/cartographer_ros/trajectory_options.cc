...
TrajectoryOptions CreateTrajectoryOptions(
  ...
  options.odom_frame
    = lua_parameter_dictionary->GetString("odom_frame");
  ...
  options.use_odometry
    = lua_parameter_dictionary->GetBool("use_odometry");
  options.use_nav_sat
    = lua_parameter_dictionary->GetBool("use_nav_sat");
  options.use_landmarks
    = lua_parameter_dictionary->GetBool("use_landmarks");
  options.num_laser_scans
